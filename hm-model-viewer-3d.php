...
class HM_ModelViewer3D {
	...
	public function add_module_type_to_script( $tag, $handle, $src ) {
		...
		if ( 'model-viewer-lib' === $handle || 'model-viewer-lib-editor' === $handle ) {
